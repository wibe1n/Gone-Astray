...
public class Keybind : MonoBehaviour {
		...
		if (pressing) {
			...
			if (e.isKey) {
				...
				case 6:
					...
					break;
				case 7:
					undyObj.talkKey = keyCode;
					talkButton.GetComponentInChildren<Text> ().text = keyCode.ToString ();
					break;
				default:
	...
	public void talkPress(){
		whichButton = 7;
		talkButton.GetComponentInChildren<Text> ().text = "press key to bind";
	}
}
