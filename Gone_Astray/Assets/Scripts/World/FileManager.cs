...
public class FileManager
{
    ...
    //tekee datapolun tietokoneen omasta kansioon liitetystä tiestä ja tiedoston nimestä
    //Muuttaa datan Json muotoon ja antaa sen eteenpäin
    ...
    //Muodostaa datan Json muotoon ja tallentaa sen
